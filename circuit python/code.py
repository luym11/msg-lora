...
header_text = Label(terminalio.FONT, text="  lora                                Bat:" + battery_level,
...
rfm9x.send(bytes("online - commlink open\r\n", "utf-8"))
term.write("online - commlink open\r\n")
